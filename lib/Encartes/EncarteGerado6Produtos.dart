...
class EncarteGerado6Produtos extends StatefulWidget {
  ...
  EncarteGerado6Produtos(this.listaProdutos, this.fundoEncarte, this.temaEncarte, this.validade);
  @override
  _EncarteGerado6ProdutosState createState() => _EncarteGerado6ProdutosState();
}

class _EncarteGerado6ProdutosState extends State<EncarteGerado6Produtos> {
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Padding(padding: EdgeInsets.all(2)),
                                      ProductEncarte(width*0.3, widget.listaProdutos[5]),
                                    ],
                                  ),
                                ),
