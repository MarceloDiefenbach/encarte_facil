...
class EditarEncarteComTemaPRO extends StatefulWidget {

  List listaEncartes;
  int posicaoNaLista;
  String fromTo;

  EditarEncarteComTemaPRO(this.listaEncartes, this.posicaoNaLista, this.fromTo);

  @override
  _EditarEncarteComTemaPROState createState() => _EditarEncarteComTemaPROState();
}

class _EditarEncarteComTemaPROState extends State<EditarEncarteComTemaPRO> {
